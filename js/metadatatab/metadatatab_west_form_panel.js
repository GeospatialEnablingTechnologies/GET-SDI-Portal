    ...
    columns: [
        {
            ...
            sortable: true,
            width: 25,
            renderer: metadata_search_store_columns_zoomtoextent_renderer,
            hidable: false
        },
        {
            header: '',
            ...
            sortable: true,
            width: 25,
            renderer: metadata_search_store_columns_showinfo_renderer,
            hidable: false
        },
        {
            header: _metadata_results_lecture_service_type,
            dataIndex: "icon",
            sortable: true,
            width: 60,
            renderer: metadata_search_store_columns_format_renderer
        },
...
function metadata_search() {
    if (Ext.getCmp("metadata_search_where_group").getChecked()[0].inputValue == "1") {
        metadata_search_map_search_area = metadataMapGetExtent();
        if (metadataMapGetCurrentProjection() != "EPSG:4326") {
            metadata_search_map_search_area.transform(new OpenLayers.Projection(metadataMapGetCurrentProjection()), new OpenLayers.Projection("EPSG:4326"));
        }
